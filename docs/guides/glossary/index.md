...
- **参照章**: [第1章：Supabase概要]({{ '/chapters/chapter01/' | relative_url }})
...
- **参照章**: [第4章：パターン2 - Edge Functions活用]({{ '/chapters/chapter04/' | relative_url }})
...
- **参照章**: [第5-1章：パターン3 - 独立APIサーバー]({{ '/chapters/chapter05-1/' | relative_url }})
...
- **実用例**: ログイン状態の維持・API認証
- **参照章**: [第2章：JWT詳細]({{ '/chapters/chapter02/' | relative_url }})
...
- **参照章**: [第1章：Supabase内部構造]({{ '/chapters/chapter01/' | relative_url }})
...
- **参照章**: [第2章：RLS実装]({{ '/chapters/chapter02/' | relative_url }})
