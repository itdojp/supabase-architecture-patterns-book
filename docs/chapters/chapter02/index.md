...
**前の章**: [第1章：Supabaseアーキテクチャ理解]({{ '/chapters/chapter01/' | relative_url }})  
...
> **第1章の理解度確認**: PostgreSQL・PostgREST・Realtimeの役割を説明できますか？不安な場合は[第1章]({{ '/chapters/chapter01/' | relative_url }})を復習してください。
