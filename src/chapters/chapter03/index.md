...
**前の章**: [第2章：認証・認可設計](../chapter02/)
**次の章**: [第4章：パターン2 - Edge Functions 活用](../chapter04/)
**学習レベル**:  基礎 ➜  応用
**推定学習時間**: 6〜10時間
...
> **第2章の理解度確認**: 認証と認可の違い、RLS の役割を説明できますか？不安な場合は[第2章](../chapter02/)を復習してください。
...
```text
[OK] 「買い物リスト」を作りたい
[OK] 家族と共有したい（リアルタイム更新）
[OK] スマホからもパソコンからも使いたい
[OK] オフラインでも使えると嬉しい
```
...
| [OK] タスク完了 | タスクのチェックボックスをクリック | ステータスが「完了」に変更 |
|  タスク削除 | タスク選択→「削除」ボタン | タスクが一覧から消える |
...
**学習の進め方**：
1. [OK] **Step 1-4**: まずアプリを動かす（理解は後回し）
2. [OK] **コード解説**: 各ファイルの役割を理解
3. [OK] **小さな変更**: タイトルや色を変えてみる
4. [OK] **エラー体験**: 意図的にコードを壊して修復練習
...
| 学習項目 | 時間配分 | 重要度 | 学習方法 |
|:---------|:--------:|:------:|:---------|
|  **アーキテクチャ設計**| 3時間 |  | MVCパターンの理解 |
|  **リアルタイム機能**| 2時間 |  | WebSocket の仕組み |
|  **セキュリティ(RLS)**| 2時間 |  | ポリシーの設計思想 |
|  **UI/UX設計**| 2時間 |  | Fletの活用方法 |

**学習の進め方**：
1. [OK] **アーキテクチャ理解**: サービス層の責務分担
2. [OK] **機能拡張**: 新しい機能の追加に挑戦
3. [OK] **最適化**: パフォーマンス改善
4. [OK] **テスト**: エラーハンドリングの充実
...
- **認証実装**: [第2章：認証・認可設計](../chapter02/)を確認
- **RLS 設計**: [セキュリティ強化](../chapter07/)で詳細学習
- **パフォーマンス**: [第6章：パフォーマンス最適化](../chapter06/)で深掘り
...
| 前の章 | 現在の章 | 次の章 |
|---------|----------|--------|
| [第2章：認証・認可設計](../chapter02/) | **第3章：パターン1 - クライアントサイド実装**| [第4章：パターン2 - Edge Functions 活用](../chapter04/) |
...
### 関連章への参照
- **前提となる章**: [第2章](../chapter02/) - 認証・認可基礎
- **並行学習可能**: [第4章](../chapter04/) - Edge Functions
- **後続の発展**: [第6章](../chapter06/) - パフォーマンス最適化
...
### [OK] **習得できたスキル**
- [OK] Python Flet + Supabase Clientの統合実装
- [OK] リアルタイム更新機能の実装
- [OK] オフライン対応・エラーハンドリング
- [OK] クライアントサイドアーキテクチャの設計パターン理解
...
- **前の章**: [第2章：認証・認可設計](../chapter02/)
- **次の章**: [第4章：パターン2 - Edge Functions 活用](../chapter04/)
- **同レベル**: [第5-1章：パターン3 - 独立 API サーバー](../chapter05-1/)
